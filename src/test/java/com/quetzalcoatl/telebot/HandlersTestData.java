...
public class HandlersTestData {
    ...
    public static final String TEST_MESSAGE_EXCHANGE_RATE_KEY = "/exchangerates";
    ...
    static {
        List<String> exchangeRateHandlerMessages = Arrays.asList(InfoType.EXCHANGE_RATES.value,
        ...
        List<String> startHandlerMessages = Collections.singletonList("/start");
