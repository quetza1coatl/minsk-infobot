...
public class HandlersTestData {
    ...
    static {
        List<String> exchangeRateHandlerMessages = Arrays.asList(Constants.CALLBACK_DATA_EXCHANGE_RATES, "/exchange", "Что с курсом валют","Эй, что с курсом валют?", "дай курс валюты",
                "курс валюты", "курс валюты!", "курсы валют", "курсы валют?", "Какие на сегодня курсы валюты");
        List<String> startHandlerMessages = Arrays.asList("/start", "Старт", "старт", "СтарТ");
